---
mapped_pages:
  - https://www.elastic.co/guide/en/beats/filebeat/current/filebeat-module-snmptrap.html
---

# snmptrap module [filebeat-module-snmptrap]

This is the snmptrap module.

## Compatibility [_compatibility_4]

TODO: document with what versions of the software is this tested

### Variable settings [snmptrap-settings]
